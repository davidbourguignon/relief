#ifndef __FRISKET_TOOL_HH__
#define __FRISKET_TOOL_HH__

class Brush_tool;

class Frisket_tool : public Brush_tool {
public:
  Frisket_tool(Toolbox *toolbox);
  virtual ~Frisket_tool(void);
